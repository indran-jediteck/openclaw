...
summary: Machine-checked security models for LynkAI’s highest-risk paths.
read_when:
...
This page tracks LynkAI’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that LynkAI enforces its
...
**What this is not (yet):** a proof that “LynkAI is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/lynkai-formal-models](https://github.com/vignesh07/lynkai-formal-models).
...
```bash
git clone https://github.com/vignesh07/lynkai-formal-models
cd lynkai-formal-models
