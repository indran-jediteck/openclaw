---
summary: "Overview of LynkAI onboarding options and flows"
read_when:
...
LynkAI supports multiple onboarding paths depending on where the Gateway runs
...
- [`lynkai onboard` command](/cli/onboard)

## macOS app onboarding

Use the LynkAI app when you want a fully guided setup on macOS. Docs:
