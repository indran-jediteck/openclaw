...
read_when:
  - You are building a LynkAI plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (lynkai.plugin.json)

Every plugin **must** ship a `lynkai.plugin.json` file in the **plugin root**.
LynkAI uses this manifest to validate configuration **without executing plugin
