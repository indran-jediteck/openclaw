...
LynkAI ships three update channels:
...
When you **explicitly** switch channels with `--channel`, LynkAI also aligns
the install method:
...
When you switch channels with `lynkai update`, LynkAI also syncs plugin sources:
