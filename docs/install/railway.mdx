...
Deploy LynkAI on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/lynkai` — Control UI
...
- `OPENCLAW_STATE_DIR=/data/.lynkai` (recommended)
...
This exports your LynkAI state + workspace so you can migrate to another host without losing config or memory.
