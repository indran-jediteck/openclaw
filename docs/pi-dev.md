...
This guide summarizes a sane workflow for working on the pi integration in LynkAI.
...
- Trigger the agent directly:
  - `pnpm lynkai agent --message "Hello" --thinking low`
...
State lives under the LynkAI state directory. Default is `~/.lynkai`. If `OPENCLAW_STATE_DIR` is set, use that directory instead.

To reset everything:

- `lynkai.json` for config
...
- [https://docs.lynkai.ai/testing](https://docs.lynkai.ai/testing)
- [https://docs.lynkai.ai/start/getting-started](https://docs.lynkai.ai/start/getting-started)
