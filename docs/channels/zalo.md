...
- Install via CLI: `lynkai plugins install @lynkai/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `lynkai plugins install ./extensions/zalo`
   - From npm (if published): `lynkai plugins install @lynkai/zalo`
...
- Approve via:
  - `lynkai pairing list zalo`
  - `lynkai pairing approve zalo <CODE>`
...
- Example: `lynkai message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `lynkai channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `lynkai logs --follow`
