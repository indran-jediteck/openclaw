...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure LynkAI HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `lynkai pairing approve slack <code>`.
...
LynkAI supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, LynkAI falls back to normal delivery for remaining payloads.
