...
LynkAI treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.lynkai/settings/voicewake.json`

Shape:

```json
{ "triggers": ["lynkai", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
