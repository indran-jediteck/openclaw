...
本指南总结了在 LynkAI 中开发 Pi 集成的合理工作流程。
...
状态存储在 LynkAI 状态目录下。默认为 `~/.lynkai`。如果设置了 `OPENCLAW_STATE_DIR`，则使用该目录。
...
- https://docs.lynkai.ai/testing
- https://docs.lynkai.ai/start/getting-started
