...
通过一键模板在 Railway 上部署 LynkAI，并在浏览器中完成设置。
...
- `https://<your-railway-domain>/lynkai` — 控制面板 UI
...
- `OPENCLAW_STATE_DIR=/data/.lynkai`（推荐）
...
这会导出你的 LynkAI 状态和工作区，方便你迁移到其他主机而不丢失配置或记忆。
