...
You can point LynkAI at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or LynkAI
...
- [Anthropic provider](/providers/anthropic) - Native LynkAI integration with Claude setup-token or API keys
