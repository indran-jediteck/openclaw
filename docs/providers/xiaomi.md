---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with LynkAI"
read_when:
  - You want Xiaomi MiMo models in LynkAI
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). LynkAI uses
