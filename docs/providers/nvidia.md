---
summary: "Use NVIDIA's OpenAI-compatible API in LynkAI"
read_when:
  - You want to use NVIDIA models in LynkAI
...
lynkai onboard --auth-choice skip
lynkai models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
