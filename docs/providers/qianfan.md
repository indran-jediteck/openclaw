---
summary: "Use Qianfan's unified API to access many models in LynkAI"
read_when:
...
3. LynkAI installed on your system
...
4. Copy the API key for use with LynkAI

## CLI setup

```bash
lynkai onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [LynkAI Configuration](/gateway/configuration)
