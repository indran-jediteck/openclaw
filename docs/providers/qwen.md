---
summary: "Use Qwen OAuth (free tier) in LynkAI"
read_when:
  - You want to use Qwen with LynkAI
...
If you already logged in with the Qwen Code CLI, LynkAI will sync credentials
