---
summary: "Use Synthetic's Anthropic-compatible API in LynkAI"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. LynkAI registers it as the
...
Note: LynkAI's Anthropic client appends `/v1` to the base URL, so use
